...
void DefeatRoachesMctsBot::OnStep() {
    ...
    case Action::AttackLowestEnemy:
    {
        ...
        for (const auto& unit : terran_units) {
            // récupération de la position de l'unité alliée
            sc2::Point2D unit_pos = unit->pos;
            // calcul du vecteur entre l'unité alliée et l'armée ennemie
            ...
            // si l'unitée alliée n'est pas à portée d'attaque alors 
