...
const char* kMapDefeatRoaches    = "Example/DefeatRoaches.SC2Map";
const char* kMapDefeatZerglingsAndBanelings = "Example/DefeatZerglingsAndBanelings.SC2Map";
const char* kMapFindAndDefeatZerglings = "Example/FindAndDefeatZerglings.SC2Map";
}
